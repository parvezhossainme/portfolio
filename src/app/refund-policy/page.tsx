  ...
  <main className="max-w-5xl mx-auto pt-20 sm:pt-24 pb-12 px-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mb-4">This Refund Policy applies to purchases and services made through parvezdev.com and to any related offerings or services provided by Parvez Hossain. References to &quot;we&quot;, &quot;us&quot;, or &quot;our&quot; refer to Parvez Hossain where applicable.</p>
          ...
          <p className="mb-2 text-sm">This Policy covers paid services, deposits, and fees charged for project work, consulting, and digital goods sold directly by Parvez Hossain via parvezdev.com.</p>
          ...
          <p className="mb-2 text-sm">To request a refund, please do the following:
            <ol className="list-decimal list-inside ml-5 mt-2">
              <li>Identify where you purchased the service (parvezdev.com) and include an invoice/order number or proof of
                payment.</li>
              <li>Email <a className="underline text-primary" href="mailto:parvezhossainme@gmail.com">parvezhossainme@gmail.com</a> with your request and supporting documentation.
              </li>
          ...
          <p className="mb-2 text-sm">For refund requests or questions: <a className="underline text-primary" href="mailto:parvezhossainme@gmail.com">parvezhossainme@gmail.com</a>. General inquiries: <a className="underline text-primary" href="mailto:parvezhossainme@gmail.com">parvezhossainme@gmail.com</a>.</p>
